...
class Model(nn.Module):
    def __init__(
        self, config, ch=3, nc=None, anchors=None
...
def build_network(config, ic, nc):
    ...
    backbone = EfficientRep(
        in_channels=ic, channels_list=channels_list, num_repeats=num_repeat
    )
...
def build_effidehead_layer(channels_list, num_anchors, nc):
    head_layers = nn.Sequential(
        ...
        # cls_pred0
        nn.Conv2d(
            in_channels=channels_list[6], out_channels=nc * num_anchors, kernel_size=1
        ),
        # reg_pred0
        nn.Conv2d(
        ...
        # cls_pred1
        nn.Conv2d(
            in_channels=channels_list[8], out_channels=nc * num_anchors, kernel_size=1
        ),
        # reg_pred1
        nn.Conv2d(
        ...
        # cls_pred2
        nn.Conv2d(
            in_channels=channels_list[10], out_channels=nc * num_anchors, kernel_size=1
        ),
        # reg_pred2
        nn.Conv2d(
